...
const sleep = (ms) => {
  ...
  export async function fetchAssetChart(startDate, endDate) {
    await sleep(1000);
  const url = `https://api.exchange.coinbase.com/products/ETH-USD/candles?start=1665019709023&end=1665451709023&granularity=3600`;
